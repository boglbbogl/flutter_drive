          ...
          children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          context
                              .read<CourseAnimationProvider>()
                              .addressSearchBar(value: true);
                        },
                        child: SizedBox(
            ...
            GestureDetector(
              onTap: () {
                context
                    .read<CourseAnimationProvider>()
                    .addressSearchBar(value: false);
              },
              child: AnimatedContainer(
                duration: const Duration(milliseconds: 200),
                transform: Matrix4.translationValues(0,
                    context.watch<CourseAnimationProvider>().yTopPosition, 0),
                height: size.height,
                color: const Color.fromRGBO(51, 51, 51, 1),
              ),
            ),
            Positioned(
              ...
              child: AnimatedContainer(
                ...
                transform: Matrix4.translationValues(
                    0,
                    context.watch<CourseAnimationProvider>().yBottomPosition,
                    0),
                child: Container(
                  width: size.width,
