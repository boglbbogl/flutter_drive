    ...
    return _then(_value.copyWith(
      ...
      contentsDocKey: contentsDocKey == freezed
          ...
          : contentsDocKey // ignore: cast_nullable_to_non_nullable
              as List<String>,
      likesDocKey: likesDocKey == freezed
          ? _value.likesDocKey
          : likesDocKey // ignore: cast_nullable_to_non_nullable
              as List<String>,
      bookmarksDocKey: bookmarksDocKey == freezed
          ? _value.bookmarksDocKey
          : bookmarksDocKey // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
class _$_ActivityModel extends _ActivityModel {
  ...
  @override
  String toString() {
    return 'ActivityModel(userKey: $userKey, contentsDocKey: $contentsDocKey, likesDocKey: $likesDocKey, bookmarksDocKey: $bookmarksDocKey, followerUserKey: $followerUserKey, followingUserKey: $followingUserKey, city: $city)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.likesDocKey, likesDocKey) &&
            const DeepCollectionEquality()
                .equals(other.bookmarksDocKey, bookmarksDocKey) &&
            const DeepCollectionEquality()
...
abstract class _ActivityModel extends ActivityModel {
  const factory _ActivityModel(
      ...
      required List<String> followerUserKey,
      required List<String> followingUserKey,
      required List<String> city}) = _$_ActivityModel;
  ...
  @override
  List<String> get likesDocKey;
  @override
  List<String> get bookmarksDocKey;
  @override
